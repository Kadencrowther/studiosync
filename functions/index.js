...
const { handleAutoPayAndRegistrationPayments } = require("./Payments-AutoPay");
...
exports.api = onRequest({
  ...
  minInstances: 0,       // Min instances (0 for scale to zero)
  maxInstances: 10       // Max instances for scaling
}, app);

// Export other functions separately
exports.handleAutoPayAndRegistrationPayments = handleAutoPayAndRegistrationPayments;
